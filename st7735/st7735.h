...
#define ST7735_RES_Pin       GPIO_PIN_1  // 复位引脚
#define ST7735_RES_GPIO_Port GPIOB
#define ST7735_CS_Pin        GPIO_PIN_10 // 片选引脚 (已直接接地)
#define ST7735_CS_GPIO_Port  GPIOA
#define ST7735_DC_Pin        GPIO_PIN_14 // 数据/命令引脚
#define ST7735_DC_GPIO_Port  GPIOB
#define LCD_BLK_Pin          GPIO_PIN_4  // 背光引脚
#define LCD_BLK_GPIO_Port    GPIOB

#define ST7735_DC_LOW()  (GPIOB->BSRR = (uint32_t)GPIO_PIN_14 << 16)
#define ST7735_DC_HIGH() (GPIOB->BSRR = GPIO_PIN_14)
...
#define ST7735_IS_160X128 1
#define ST7735_WIDTH  161   // 原为160
#define ST7735_HEIGHT 129   // 原为128
#define ST7735_XSTART (uint8_t)(0)
#define ST7735_YSTART (uint8_t)(0)
...
#define ST7735_LINE_BUFFER_SIZE (ST7735_WIDTH * 2)
extern uint8_t st7735_line_buffer[ST7735_LINE_BUFFER_SIZE];
